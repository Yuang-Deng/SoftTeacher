...
class GMMBBoxHead(BaseModule):
    ...
    def __init__(self,
                 ...
                 cls_lambda=1,
                 lam_box_loss=1,
                 student_warm_iter=40000,
                 teacher_warm_iter=3000,
                 init_cfg=None):
        ...
        self.student_warm_iter = student_warm_iter
        self.teacher_warm_iter = teacher_warm_iter
    ...
    def set_warm_iter(self, model):
        if model == 'student':
            self.warm_iter = self.student_warm_iter
        else:
            self.warm_iter = self.teacher_warm_iter